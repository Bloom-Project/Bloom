...
This means one can have an always-on BLMd instance running, and another local BLMd/BLM-qt instance which connects to this node and receives blocks from it.
