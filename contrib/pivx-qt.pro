...
RESOURCES += src/qt/BLM.qrc src/qt/BLM_locale.qrc

TRANSLATIONS += src/qt/locale/BLM_bg.ts \
                src/qt/locale/BLM_de.ts \
                src/qt/locale/BLM_en.ts \
                src/qt/locale/BLM_es.ts \
                src/qt/locale/BLM_fi.ts \
                src/qt/locale/BLM_fr.ts \
                src/qt/locale/BLM_it.ts \
                src/qt/locale/BLM_ja.ts \
                src/qt/locale/BLM_pl.ts \
                src/qt/locale/BLM_pt.ts \
                src/qt/locale/BLM_ru.ts \
                src/qt/locale/BLM_sk.ts \
                src/qt/locale/BLM_sv.ts \
                src/qt/locale/BLM_vi.ts \
                src/qt/locale/BLM_zh_CN.ts \
                src/qt/locale/BLM_zh_TW.ts
