                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BLM Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BLM address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and BLM: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BLM Core"), this);
    aboutAction->setStatusTip(tr("Show information about BLM Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BLM"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BLM addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BLM addresses"));
    ...
    openAction->setStatusTip(tr("Open a BLM: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BLM Core help message to get a list with possible BLM command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BLM Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BLM network", "", count));
}
...
{
    QString strTitle = tr("BLM Core"); // default title
