...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BLM features */
        {"BLM", "masternode", &masternode, true, true, false},
        {"BLM", "masternodelist", &masternodelist, true, true, false},
        {"BLM", "mnbudget", &mnbudget, true, true, false},
        {"BLM", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"BLM", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BLM", "mnsync", &mnsync, true, true, false},
        {"BLM", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"BLM", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use BLMd, or the -server option to BLM-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> BLM-cli " + methodname + " " + args + "\n";
}
