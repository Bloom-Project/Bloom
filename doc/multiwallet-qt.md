...
In order to support loading of multiple wallets in BLM-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is BLM.cpp.
...
Changes to BLM.cpp
----------------------
BLM.cpp is the entry point into BLM-qt, and as such, will require some minor modifications to provide hooks for
