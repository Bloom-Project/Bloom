...
This mechanism has been integrated into Bitcore-Node-BLM which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BLM-Project/insight-api-BLM#web-socket-api](https://github.com/BLM-Project/insight-api-BLM#web-socket-api) 
* API: [https://github.com/BLM-Project/insight-api-BLM#swifttx-transactions](https://github.com/BLM-Project/insight-api-BLM#swifttx-transactions) 
...
By default, the BLM Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BLM Core daemon:
